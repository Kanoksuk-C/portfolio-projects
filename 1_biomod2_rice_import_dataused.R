...
## 1. Import rice cultivation and current climate data ###########
...
## 2. Import Future Climate Data ##################################

## 2.1 HadGEM2-CC climate data (import_HadGEM2-CC.R) #############
...
## 2.2 IPSL-CM5A-LR climate data (import_IPSL-CM5A-LR.R) #########
...
## 2.3 MIROC-ESM-CHEM climate data ###############################
